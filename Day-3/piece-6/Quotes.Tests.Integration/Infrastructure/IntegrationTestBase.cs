...
/// <summary>
/// Base class for integration tests. xUnit creates a new instance per test method,
/// so each test gets its own SqliteConnection, factory, and HttpClient — zero shared state.
/// </summary>
public abstract class IntegrationTestBase : IDisposable
{
    ...
    protected IntegrationTestBase()
    {
        ...
        _connection.Open();
        Factory = new QuotesApiFactory(_connection);
