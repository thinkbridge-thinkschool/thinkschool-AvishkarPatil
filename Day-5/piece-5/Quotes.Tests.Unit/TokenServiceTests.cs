...
public class TokenServiceTests
{
    ...
    private static IOptionsSnapshot<JwtOptions> BuildJwtOptions(int expiresInMinutes = 15)
    {
        var options = new JwtOptions
        {
            Key                         = "unit-test-key-32bytes-minimum-xx!!",
            Issuer                      = "TestIssuer",
            Audience                    = "TestAudience",
            AccessTokenExpiresInMinutes = expiresInMinutes,
    ...
    private static TokenService BuildSut(IClock clock, int expiresInMinutes = 15) =>
        new(BuildJwtOptions(expiresInMinutes), clock);
